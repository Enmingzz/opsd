...
# The output step_500 in RESUME_DIR is the logical 1500-step checkpoint.
set -euo pipefail
...
BASE_TRAIN_DIR=/scratch/enmingzz/temp/opsd_runs/multiratio_010_020_030_040_3000/divprune_kl_multiratio_010_020_030_040
BASE_ADAPTER="${BASE_TRAIN_DIR}/step_1000"
RESUME_DIR="${OUT_ROOT}/divprune_kl_multiratio_010_020_030_040_resume_from_step1000_to_step1500"
...
echo "OPSD multi-ratio logical step_1500 resume complete at $(date)"
echo "Logical step_1500 adapter: ${RESUME_DIR}/step_500"
